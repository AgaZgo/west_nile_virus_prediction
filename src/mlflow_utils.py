...
from src.config import (
    RESAMPLE_METHOD, LAG_LIST, WINDOW_LIST, NUM_WEATHER_FEATURES, 
    NUM_AGG_FEATURES, FEATURE_SELECTOR, MODEL, N_TRIALS
)


def generate_run_name():
    return RESAMPLE_METHOD + datetime.now().strftime("_%y%m%d_%H%M%S")
...
def log_config_to_mlflow():
    config_params = {
        ...
        'cfg_resample_method': RESAMPLE_METHOD,
        'cfg_model': MODEL,
